...
- **Source**: contiki-ng commit `509e0b236c2eff219bd8e5da751da279e00f3da3`
- **Source path**: `examples/rpl-udp` (file: `udp-server.c`)
- **TARGET**: `nrf`
- **BOARD**: `nrf54l15/dk`
- **Toolchain**: host
- **Built**: 2026-09-07T15:52:10Z by Niclas Finne
- **Build command**: `tools/build-device-firmware.sh --target nrf --board nrf54l15/dk --example examples/rpl-udp --output firmware/nrf54l15-dk/udp-server.nrf54l15-dk --source-file udp-server --local`
...
- **BOARD**: `nrf54l15/dk`
- **Toolchain**: host
- **Built**: 2026-09-07T15:52:26Z by Niclas Finne
- **Build command**: `tools/build-device-firmware.sh --target nrf --board nrf54l15/dk --example examples/rpl-udp --output firmware/nrf54l15-dk/udp-client.nrf54l15-dk --source-file udp-client --local`
