CC = cc
CFLAGS = -O3 -Wall -Wextra -Wno-unused-parameter -std=c11 -I include/msp430 -I include/arm -I include/native -I lib -march=native -flto
LDFLAGS = -lm -flto
...
$(BUILD_DIR)/test_runner: $(OBJECTS) $(ARM_OBJECTS) $(NATIVE_OBJECTS) $(LIB_OBJECTS) $(TEST_OBJECTS) | $(BUILD_DIR)
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)
...
# Debug build
debug: CFLAGS = -O0 -g -Wall -Wextra -Wno-unused-parameter -std=c11 -I include/msp430 -I include/arm -I include/native -I lib -DDEBUG
debug: LDFLAGS = -lm
debug: clean $(BUILD_DIR)/test_runner

# Profile-guided optimization (Apple Clang)
PGO_CFLAGS = -O3 -std=c11 -I include/msp430 -I include/arm -I include/native -I lib -march=native
PGO_LDFLAGS = -lm
ifneq ($(LIGHTNING_LIBS),)
...
pgo:
	...
	$(CC) $(PGO_CFLAGS) -fprofile-instr-generate \
		$(SOURCES) $(ARM_SOURCES) $(NATIVE_SOURCES) $(LIB_SOURCES) $(TEST_SOURCES) -o $(BUILD_DIR)/test_runner $(PGO_LDFLAGS)
	...
	$(CC) $(CFLAGS) -fprofile-instr-use=$(BUILD_DIR)/default.profdata \
		$(SOURCES) $(ARM_SOURCES) $(NATIVE_SOURCES) $(LIB_SOURCES) $(TEST_SOURCES) -o $(BUILD_DIR)/test_runner $(LDFLAGS)
